                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                    ...
                                    <div className="layout-row justify-content-between align-items-center">
                                        <button className="x-small icon-only outlined" onClick={() => this.props.decreaseQuantity(product)}
                                        ...
                                        <button className="x-small icon-only outlined" onClick={() => this.props.increaseQuantity(product)}
